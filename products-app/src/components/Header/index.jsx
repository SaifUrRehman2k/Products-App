    ...
    <div className='mainHeader'>
      <header className='flex-row-wrap justify-between p-0-1 m-0 align-center'>
        ...
        <div className='myAcc flex-row-nowrap align-center justify-center'>
          ...
          <Link to={accValue ? '/myAccount' : '/login'} style={{ borderRight: "1px solid rgba(113, 113, 113, 0.807)", }} className='iconLink  flex-row-nowrap align-center justify-center m-0 p-0-1'>
